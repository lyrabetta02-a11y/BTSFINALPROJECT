      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-white/70 text-sm">
                {t("projects.categories.chiller")}
              </li>
              <li className="text-white/70 text-sm">
                {t("projects.categories.vrv")}
              </li>
              <li className="text-white/70 text-sm">
                {t("projects.categories.ducting")}
              </li>
              <li className="text-white/70 text-sm">
                {t("projects.categories.maintenance")}
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/70 text-sm">
                  Jl. Melati Raya, Gunung Sindur, Bogor, Indonesia
                </span>
              </li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <span className="text-white/50 text-xs cursor-pointer hover:text-white">
              {t("footer.privacy")}
            </span>
            <span className="text-white/50 text-xs cursor-pointer hover:text-white">
              {t("footer.terms")}
