        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <span className="text-accent font-medium tracking-widest uppercase text-sm mb-2 block">Our Portfolio</span>
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-primary">Featured Projects</h2>
            </div>
            <Link href="/projects">
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-white/80 max-w-2xl mx-auto mb-10 text-lg">
            Contact our team today for a consultation and discover how we can deliver superior climate control solutions for your business.
          </p>
